...
import {BsMessenger, BsLinkedin, BsTwitter, BsDiscord, BsInstagram, BsGithub, BsYoutube, BsTwitch} from 'react-icons/bs'
    ...
    return(
        ...
        <div className="contact">
            <div className="skills"><br/>
                ...
                <a  href="mailto:dedryver.cedric@gmail.com" target="_blank"><MdEmail size={70}/><br/><br/></a>
                ...
                <a href="https://www.youtube.com/channel/UC96Q3CfAA0uAqOsngmhBaKw" target="_blank"  target='_blank'><BsYoutube className="contact-logo" size={50}/></a>
                <a href="https://www.twitch.tv/oiinkoiink" target="_blank" target='_blank'><BsTwitch  className="contact-logo" size={50}/></a><br/>
            </div>
